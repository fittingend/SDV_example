...
/// EXECUTABLE NAME                   : InfoHealthTest
...
infohealthtest::aa::InfoHealthTest* g_swcInfoHealthTest{nullptr};
 
static void SignalHandler(std::int32_t signal)
{
    if (signal == SIGTERM || signal == SIGINT)
    {
        g_swcInfoHealthTest->Terminate();
    }
}
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("HEAL", "InfoHealthTest's main function")};
        ...
        infohealthtest::aa::InfoHealthTest swcInfoHealthTest;
        g_swcInfoHealthTest = &swcInfoHealthTest;
        
        // initialize software component
        proceed = swcInfoHealthTest.Initialize();
        
        if (proceed)
        {
            // start software component
            swcInfoHealthTest.Start();
