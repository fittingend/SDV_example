...
void RPortRoa::RegistReceiversoaRoaDetectCount()
{
    if (m_found)
    {
        ...
        {
            m_logger.LogVerbose() << "RPortRoa::RegistReceiversoaRoaDetectCount::SetReceiveHandler";
        }
        else
        {
...
void RPortRoa::GetsoaRoaDetectCount()
{
    if (m_found)
    {
        ...
        {
            m_logger.LogVerbose() << "RPortRoa::GetsoaRoaDetectCount::Responded";
...
void RPortRoa::RegistReceiversoaRoaDetectState()
{
    if (m_found)
    {
        ...
        if (callback.HasValue())
        {
            m_logger.LogVerbose() << "RPortRoa::RegistReceiversoaRoaDetectState::SetReceiveHandler";
        }
        else
        {
...
void RPortRoa::GetsoaRoaDetectState()
{
    if (m_found)
    {
        ...
        if (response.HasValue())
        {
            m_logger.LogVerbose() << "RPortRoa::GetsoaRoaDetectState::Responded";
...
void RPortRoa::RegistReceiversoaRoaDeviceNormal()
{
    if (m_found)
    {
        ...
        if (callback.HasValue())
        {
            m_logger.LogVerbose() << "RPortRoa::RegistReceiversoaRoaDeviceNormal::SetReceiveHandler";
        }
        else
        {
...
void RPortRoa::GetsoaRoaDeviceNormal()
{
    if (m_found)
    {
        ...
        if (response.HasValue())
        {
            m_logger.LogVerbose() << "RPortRoa::GetsoaRoaDeviceNormal::Responded";
...
void RPortRoa::RegistReceiversoaRoaMode()
{
    if (m_found)
    {
        ...
        if (callback.HasValue())
        {
            m_logger.LogVerbose() << "RPortRoa::RegistReceiversoaRoaMode::SetReceiveHandler";
        }
        else
        {
...
void RPortRoa::GetsoaRoaMode()
{
    if (m_found)
    {
        ...
        if (response.HasValue())
        {
            m_logger.LogVerbose() << "RPortRoa::GetsoaRoaMode::Responded";
...
void RPortRoa::RegistReceiversoaRoaRunningState()
{
    if (m_found)
    {
        ...
        if (callback.HasValue())
        {
            m_logger.LogVerbose() << "RPortRoa::RegistReceiversoaRoaRunningState::SetReceiveHandler";
        }
        else
        {
...
void RPortRoa::GetsoaRoaRunningState()
{
    if (m_found)
    {
        ...
        if (response.HasValue())
        {
            m_logger.LogVerbose() << "RPortRoa::GetsoaRoaRunningState::Responded";
...
void RPortRoa::RegistReceiversoaRoaSensorError()
{
    if (m_found)
    {
        ...
        if (callback.HasValue())
        {
            m_logger.LogVerbose() << "RPortRoa::RegistReceiversoaRoaSensorError::SetReceiveHandler";
        }
        else
        {
...
void RPortRoa::GetsoaRoaSensorError()
{
    if (m_found)
    {
        ...
        if (response.HasValue())
        {
            m_logger.LogVerbose() << "RPortRoa::GetsoaRoaSensorError::Responded";
...
void RPortRoa::RegistReceiversoaRoaSwVersion()
{
    if (m_found)
    {
        ...
        if (callback.HasValue())
        {
            m_logger.LogVerbose() << "RPortRoa::RegistReceiversoaRoaSwVersion::SetReceiveHandler";
        }
        else
        {
...
void RPortRoa::GetsoaRoaSwVersion()
{
    if (m_found)
    {
        ...
        if (response.HasValue())
        {
            m_logger.LogVerbose() << "RPortRoa::GetsoaRoaSwVersion::Responded";
