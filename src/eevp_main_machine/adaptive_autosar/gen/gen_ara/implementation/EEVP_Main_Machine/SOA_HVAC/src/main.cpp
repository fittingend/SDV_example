...
soa_hvac::aa::SOA_HVAC* g_swcSOA_HVAC{nullptr};
 
static void SignalHandler(std::int32_t signal)
{
    if (signal == SIGTERM || signal == SIGINT)
    {
        g_swcSOA_HVAC->Terminate();
    }
}
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("SHVC", "SOA_HVAC's main function")};
        ...
        soa_hvac::aa::SOA_HVAC swcSOA_HVAC;
        g_swcSOA_HVAC = &swcSOA_HVAC;
        
        // initialize software component
        proceed = swcSOA_HVAC.Initialize();
