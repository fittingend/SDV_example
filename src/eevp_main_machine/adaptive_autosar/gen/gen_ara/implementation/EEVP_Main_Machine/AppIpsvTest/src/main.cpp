...
appipsvtest::rootswcomponent::AppIpsvTest* g_swcAppIpsvTest{nullptr};
 
static void SignalHandler(std::int32_t signal)
{
    if (signal == SIGTERM || signal == SIGINT)
    {
        g_swcAppIpsvTest->Terminate();
    }
}
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("IPSV", "AppIpsvTest's main function")};
        ...
        appipsvtest::rootswcomponent::AppIpsvTest swcAppIpsvTest;
        g_swcAppIpsvTest = &swcAppIpsvTest;
        
        // initialize software component
        proceed = swcAppIpsvTest.Initialize();
        
        if (proceed)
        {
            // start software component
            swcAppIpsvTest.Start();
