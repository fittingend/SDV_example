...
/// EXECUTABLE NAME                   : ServiceCreator
...
servicecreator::aa::ServiceCreator* g_swcServiceCreator{nullptr};
 
static void SignalHandler(std::int32_t signal)
{
    if (signal == SIGTERM || signal == SIGINT)
    {
        g_swcServiceCreator->Terminate();
    }
}
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("SVCT", "ServiceCreator's main function")};
        ...
        servicecreator::aa::ServiceCreator swcServiceCreator;
        g_swcServiceCreator = &swcServiceCreator;
        
        // initialize software component
        proceed = swcServiceCreator.Initialize();
        
        if (proceed)
        {
            // start software component
            swcServiceCreator.Start();
