...
class VCS_BrakeSkeletonImpl : public VCS_BrakeSkeleton
{
public:
    /// @brief Constructor
    VCS_BrakeSkeletonImpl(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent);
    ...
    ara::core::Future<VCS_BrakeSkeleton::setTargetAxOutput> setTargetAx(const eevp::simulation::type::VCS_Acceleration& ax) override;
    
    /// @brief Request with Response method, setTotalForce
    ara::core::Future<VCS_BrakeSkeleton::setTotalForceOutput> setTotalForce(const eevp::simulation::type::VCS_LgtBrkFTotal& lgtBrkFTotal) override;
...
private:
    ...
    std::unique_ptr<eevp::simulation::skeleton::VCS_BrakeSkeletonImpl> m_interface;
