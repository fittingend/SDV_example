...
private:
    ...
    /// @brief Instance of Port {ServiceCreator.PPort_BCM_ExteriorSignal}
    std::unique_ptr<servicecreator::aa::port::PPort_BCM_ExteriorSignal> m_PPort_BCM_ExteriorSignal;
