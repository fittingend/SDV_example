...
bool ServiceCreator::Initialize()
{
    ...
    m_PPort_BCM_ExteriorSignal = std::make_unique<servicecreator::aa::port::PPort_BCM_ExteriorSignal>();
...
void ServiceCreator::Start()
{
    ...
    m_PPort_BCM_ExteriorSignal->Start();
...
void ServiceCreator::Terminate()
{
    ...
    m_PPort_BCM_ExteriorSignal->Terminate();
...
void ServiceCreator::Run()
{
    ...
    m_workers.Async([this] { m_PPort_BCM_ExteriorSignal->NotifyFieldhornStateCyclic(); });
    m_workers.Async([this] { m_PPort_BCM_ExteriorSignal->NotifyFieldlightStateCyclic(); });
