...
{
    m_logger.LogVerbose() << "RPortWiper::Start";
    ...
    if (find.HasValue())
    {
        m_logger.LogVerbose() << "RPortWiper::Start::StartFindService";
    }
    else
    {
...
{
    m_logger.LogVerbose() << "RPortWiper::Terminate";
    ...
    if (m_interface)
    {
        ...
        m_logger.LogVerbose() << "RPortWiper::Terminate::StopFindService";
    }
}
...
void RPortWiper::Find(ara::com::ServiceHandleContainer<eevp::control::proxy::SoaWiperProxy::HandleType> handles, ara::com::FindServiceHandle findHandle)
{
    ...
    if (handles.empty())
    {
        m_logger.LogVerbose() << "RPortWiper::Find::Service Instances not found";
        return;
    }
    else
    {
        ...
        {
            m_logger.LogVerbose() << "RPortWiper::Find::Searched Instance::ServiceId =" << 
    ...
    if (m_interface)
    {
        m_logger.LogVerbose() << "RPortWiper::Find::Proxy is already running";
    }
    else
    {
        m_logger.LogVerbose() << "RPortWiper::Find::Using Instance::ServiceId =" << 
...
void RPortWiper::SubscribesoaWiperDeviceNormal()
{
    if (m_found)
    {
        ...
        {
            m_logger.LogVerbose() << "RPortWiper::SubscribesoaWiperDeviceNormal::Subscribed";
        }
        else
        {
...
void RPortWiper::StopSubscribesoaWiperDeviceNormal()
{
    if (m_found)
    {
        ...
        m_logger.LogVerbose() << "RPortWiper::StopSubscribesoaWiperDeviceNormal::Unsubscribed";
    }
}
...
void RPortWiper::RegistReceiversoaWiperDeviceNormal()
{
    if (m_found)
    {
        ...
        {
            m_logger.LogVerbose() << "RPortWiper::RegistReceiversoaWiperDeviceNormal::SetReceiveHandler";
        }
        else
        {
...
void RPortWiper::ReceiveFieldsoaWiperDeviceNormalTriggered()
{
    if (m_found)
    {
        ...
        if (m_interface->soaWiperDeviceNormal.GetSubscriptionState() == ara::com::SubscriptionState::kSubscribed)
        {
            ...
            if (recv->HasValue())
            {
                m_logger.LogVerbose() << "RPortWiper::ReceiveFieldsoaWiperDeviceNormal::GetNewSamples::" << recv->Value();
            }
            else
            {
...
void RPortWiper::GetsoaWiperDeviceNormal()
{
    if (m_found)
    {
        ...
        {
            m_logger.LogVerbose() << "RPortWiper::GetsoaWiperDeviceNormal::Responded";
...
void RPortWiper::SubscribesoaWiperStatus()
{
    if (m_found)
    {
        ...
        if (subscribe.HasValue())
        {
            m_logger.LogVerbose() << "RPortWiper::SubscribesoaWiperStatus::Subscribed";
        }
        else
        {
...
void RPortWiper::StopSubscribesoaWiperStatus()
{
    if (m_found)
    {
        ...
        m_logger.LogVerbose() << "RPortWiper::StopSubscribesoaWiperStatus::Unsubscribed";
    }
}
...
void RPortWiper::RegistReceiversoaWiperStatus()
{
    if (m_found)
    {
        ...
        if (callback.HasValue())
        {
            m_logger.LogVerbose() << "RPortWiper::RegistReceiversoaWiperStatus::SetReceiveHandler";
        }
        else
        {
...
void RPortWiper::ReceiveFieldsoaWiperStatusTriggered()
{
    if (m_found)
    {
        ...
        if (m_interface->soaWiperStatus.GetSubscriptionState() == ara::com::SubscriptionState::kSubscribed)
        {
            ...
            if (recv->HasValue())
            {
                m_logger.LogVerbose() << "RPortWiper::ReceiveFieldsoaWiperStatus::GetNewSamples::" << recv->Value();
            }
            else
            {
...
void RPortWiper::GetsoaWiperStatus()
{
    if (m_found)
    {
        ...
        if (response.HasValue())
        {
            m_logger.LogVerbose() << "RPortWiper::GetsoaWiperStatus::Responded";
...
void RPortWiper::SubscribesoaWiperSwVersion()
{
    if (m_found)
    {
        ...
        if (subscribe.HasValue())
        {
            m_logger.LogVerbose() << "RPortWiper::SubscribesoaWiperSwVersion::Subscribed";
        }
        else
        {
...
void RPortWiper::StopSubscribesoaWiperSwVersion()
{
    if (m_found)
    {
        ...
        m_logger.LogVerbose() << "RPortWiper::StopSubscribesoaWiperSwVersion::Unsubscribed";
    }
}
...
void RPortWiper::RegistReceiversoaWiperSwVersion()
{
    if (m_found)
    {
        ...
        if (callback.HasValue())
        {
            m_logger.LogVerbose() << "RPortWiper::RegistReceiversoaWiperSwVersion::SetReceiveHandler";
        }
        else
        {
...
void RPortWiper::ReceiveFieldsoaWiperSwVersionTriggered()
{
    if (m_found)
    {
        ...
        if (m_interface->soaWiperSwVersion.GetSubscriptionState() == ara::com::SubscriptionState::kSubscribed)
        {
            ...
            if (recv->HasValue())
            {
                m_logger.LogVerbose() << "RPortWiper::ReceiveFieldsoaWiperSwVersion::GetNewSamples::" << recv->Value();
            }
            else
            {
...
void RPortWiper::GetsoaWiperSwVersion()
{
    if (m_found)
    {
        ...
        if (response.HasValue())
        {
            m_logger.LogVerbose() << "RPortWiper::GetsoaWiperSwVersion::Responded";
