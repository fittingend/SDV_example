...
lightbeep::aa::LightBeep* g_swcLightBeep{nullptr};
 
static void SignalHandler(std::int32_t signal)
{
    if (signal == SIGTERM || signal == SIGINT)
    {
        g_swcLightBeep->Terminate();
    }
}
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("LIBP", "LightBeep's main function")};
        ...
        lightbeep::aa::LightBeep swcLightBeep;
        g_swcLightBeep = &swcLightBeep;
        
        // initialize software component
        proceed = swcLightBeep.Initialize();
