...
/// EXECUTABLE NAME                   : DummyTest_Consumer
...
dummytest_consumer::aa::DummyTest_Consumer* g_swcDummyTest_Consumer{nullptr};
 
static void SignalHandler(std::int32_t signal)
{
    if (signal == SIGTERM || signal == SIGINT)
    {
        g_swcDummyTest_Consumer->Terminate();
    }
}
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("TCON", "DummyTest_Consumer's main function")};
        ...
        dummytest_consumer::aa::DummyTest_Consumer swcDummyTest_Consumer;
        g_swcDummyTest_Consumer = &swcDummyTest_Consumer;
        
        // initialize software component
        proceed = swcDummyTest_Consumer.Initialize();
        
        if (proceed)
        {
            // start software component
            swcDummyTest_Consumer.Start();
