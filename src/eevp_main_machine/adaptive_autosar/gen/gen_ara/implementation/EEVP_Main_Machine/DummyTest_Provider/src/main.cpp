...
/// EXECUTABLE NAME                   : DummyTest_Provider
...
dummytest_provider::aa::DummyTest_Provider* g_swcDummyTest_Provider{nullptr};
 
static void SignalHandler(std::int32_t signal)
{
    if (signal == SIGTERM || signal == SIGINT)
    {
        g_swcDummyTest_Provider->Terminate();
    }
}
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("TPRV", "DummyTest_Provider's main function")};
        ...
        dummytest_provider::aa::DummyTest_Provider swcDummyTest_Provider;
        g_swcDummyTest_Provider = &swcDummyTest_Provider;
        
        // initialize software component
        proceed = swcDummyTest_Provider.Initialize();
        
        if (proceed)
        {
            // start software component
            swcDummyTest_Provider.Start();
