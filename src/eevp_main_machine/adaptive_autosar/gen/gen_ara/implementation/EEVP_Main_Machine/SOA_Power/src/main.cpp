...
soa_power::aa::SOA_Power* g_swcSOA_Power{nullptr};
 
static void SignalHandler(std::int32_t signal)
{
    if (signal == SIGTERM || signal == SIGINT)
    {
        g_swcSOA_Power->Terminate();
    }
}
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("SPWR", "SOA_Power's main function")};
        ...
        soa_power::aa::SOA_Power swcSOA_Power;
        g_swcSOA_Power = &swcSOA_Power;
        
        // initialize software component
        proceed = swcSOA_Power.Initialize();
