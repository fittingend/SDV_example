...
vucm::para::VUCM* g_swcVUCM{nullptr};
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("VUCM", "VUCM's main function")};
        ...
        vucm::para::VUCM swcVUCM;
        g_swcVUCM = &swcVUCM;
        
        // initialize software component
        proceed = swcVUCM.Initialize();
