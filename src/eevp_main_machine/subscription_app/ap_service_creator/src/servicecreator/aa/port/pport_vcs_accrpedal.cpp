...
VCS_AccrPedalSkeletonImpl::VCS_AccrPedalSkeletonImpl(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode)
    : VCS_AccrPedalSkeleton(instanceSpec, mode)
    , m_logger(ara::log::CreateLogger("SVCT", "PORT", ara::log::LogLevel::kVerbose))
{
}
 
ara::core::Future<VCS_AccrPedalSkeleton::notifyAccrPedalOutput> VCS_AccrPedalSkeletonImpl::notifyAccrPedal()
{
    m_logger.LogVerbose() << "PPort_VCS_AccrPedal::notifyAccrPedal::Requested";
    
    notifyAccrPedalOutput response;
    ara::core::Promise<notifyAccrPedalOutput> promise;
...
void PPort_VCS_AccrPedal::Start()
{
    ...
    m_interface = std::make_unique<eevp::simulation::skeleton::VCS_AccrPedalSkeletonImpl>(specifier);
