...
SubscriptionManagementProxyImpl::init() {
    ...
    mLogger.LogInfo() << "Subscription StartFindService() Start!!";
    // 어떤 서비스를 찾을지 지정 (InstanceSpecifier는 AUTOSAR ARA::COM에서 사용되는 서비스 식별자)
    ara::core::InstanceSpecifier specifier("SmokingMonitor/AA/RPort_SubscriptionManagement");
